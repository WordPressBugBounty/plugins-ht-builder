...
class HTBuilder_Dashboard_Widget {
    ...
    public function dashboard_widget() {
        ...
        wp_add_dashboard_widget(
            ...
            esc_html__( 'HasThemes Stories', 'ht-builder' ),
    ...
    private static function load_template( $template ) {
        $tmp_file = HTBUILDER_PL_PATH . 'includes/admin/templates/dashboard-' . $template . '.php';
...
new HTBuilder_Dashboard_Widget();
